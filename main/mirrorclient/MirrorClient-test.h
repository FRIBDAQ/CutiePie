...
public:
	MirrorClientTest(const std::string& host, unsigned short port, char* pStorage);
	virtual ~MirrorClientTest();    // Maybe this class isn't final (in the JAVA sense).
